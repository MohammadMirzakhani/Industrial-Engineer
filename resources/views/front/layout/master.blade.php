        ...
        <div class="row"> <span class="drop-icon visible-sm visible-xs"><i class="fa fa-align-justify"></i></span>
          <div class="pull-left flip left-top">
                    ...
                    <ul>
                      <li>
                        <table>
                          <tbody>
                            <tr>
                              <td><img alt="" src="{{ asset('front/image/banner/cms-block.jpg') }}"></td>
                              <td><img alt="" src="{{ asset('front/image/banner/responsive.jpg') }}"></td>
                            </tr>
                            <tr>
            ...
            <div id="language" class="btn-group">
              <button class="btn-link dropdown-toggle" data-toggle="dropdown"> <span> <img src="{{ asset('front/image/flags/gb.png') }}" alt="انگلیسی" title="انگلیسی">انگلیسی <i class="fa fa-caret-down"></i></span></button>
              <ul class="dropdown-menu">
                <li>
                  <button class="btn btn-link btn-block language-select" type="button" name="GB"><img src="{{ asset('front/image/flags/gb.png') }}" alt="انگلیسی" title="انگلیسی" /> انگلیسی</button>
                </li>
                <li>
                  <button class="btn btn-link btn-block language-select" type="button" name="GB"><img src="{{ asset('front/image/flags/ar.png') }}" alt="عربی" title="عربی" /> عربی</button>
                </li>
              </ul>
            </div>
          ...
          <div id="top-links" class="nav pull-right flip">
              @if (auth()->check())
              <li><a href="{{route('user_profile')  }}" class="btn btn-warning">پروفابل</a></li>
              <li><form action="{{ route('logout') }}" method="post" class="form-group">@csrf<input type="submit" value="خروج" class="form-control btn btn-warning"></form></li>
              @else
              <ul>
      ...
      <div class="container">
        <div class="table-container">
          ...
          <div class="col-table-cell col-lg-6 col-md-6 col-sm-12 col-xs-12 inner">
            <div id="logo"><a href="index.html"><img class="img-responsive" src="{{ asset('front/image/logo.png') }}" title="MarketShop" alt="MarketShop" /></a></div>
          </div>
          <!-- Logo End -->
          <!-- Mini Cart Start-->
      ...
      <nav id="menu" class="navbar">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            <li><a class="home_link" title="خانه" href="{{ route('lo.index') }}">خانه</a></li>
            ...
            <li class="dropdown"> <a href="{{ route('category_products',10) }}">دیجیتال</a>
                  <div class="dropdown-menu">
                    <ul>
            ...
            <li class="menu_brands dropdown"><a href="#">برند ها</a>
              <div class="dropdown-menu">
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/apple_logo-60x60.jpg"') }}" title="اپل" alt="اپل" /></a><a href="#">اپل</a></div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/canon_logo-60x60.jpg') }}" title="کنون" alt="کنون" /></a><a href="#">کنون</a></div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"> <a href="#"><img src="{{ asset('front/image/product/hp_logo-60x60.jpg') }}" title="اچ پی" alt="اچ پی" /></a><a href="#">اچ پی</a></div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/htc_logo-60x60.jpg') }}" title="اچ تی سی" alt="اچ تی سی" /></a><a href="#">اچ تی سی</a></div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/palm_logo-60x60.jpg') }}" title="پالم" alt="پالم" /></a><a href="#">پالم</a></div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/sony_logo-60x60.jpg') }}" title="سونی" alt="سونی" /></a><a href="#">سونی</a> </div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/canon_logo-60x60.jpg') }}" title="test" alt="test" /></a><a href="#">تست</a> </div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/apple_logo-60x60.jpg') }}" title="test 3" alt="test 3" /></a><a href="#">تست 3</a></div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/canon_logo-60x60.jpg') }}" title="test 5" alt="test 5" /></a><a href="#">تست 5</a> </div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/canon_logo-60x60.jpg') }}" title="test 6" alt="test 6" /></a><a href="#">تست 6</a></div>
                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img src="{{ asset('front/image/product/apple_logo-60x60.jpg') }}" title="test 7" alt="test 7" /></a><a href="#">تست 7</a> </div>
    ...
    <div class="fpart-second">
      <div class="container">
        <div id="powered" class="clearfix">
          ...
          <div class="social pull-right flip"> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/socialicons/facebook.png') }}" alt="Facebook" title="Facebook"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/socialicons/twitter.png') }}" alt="Twitter" title="Twitter"> </a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/socialicons/google_plus.png') }}" alt="Google+" title="Google+"> </a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/socialicons/pinterest.png') }}" alt="Pinterest" title="Pinterest"> </a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/socialicons/rss.png') }}" alt="RSS" title="RSS"> </a> </div>
        </div>
        <div class="bottom-row">
          ...
          <div class="payments_types"> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/payment/payment_paypal.png') }}" alt="paypal" title="PayPal"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/payment/payment_american.png') }}" alt="american-express" title="American Express"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/payment/payment_2checkout.png') }}" alt="2checkout" title="2checkout"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/payment/payment_maestro.png') }}" alt="maestro" title="Maestro"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/payment/payment_discover.png') }}" alt="discover" title="Discover"></a> <a href="#" target="_blank"> <img data-toggle="tooltip" src="{{ asset('front/image/payment/payment_mastercard.png') }}" alt="mastercard" title="MasterCard"></a> </div>
        </div>
      </div>
    </div>
